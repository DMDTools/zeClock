...
def page1_a():
    ...
    t = helpers.render_text("C", x=20 + nw + 5, y=1, color=(255, 128, 0), font_name="MENU")
    frame = comp(frame, t)
    # Condition right-aligned area
    t = helpers.render_text("Degage", x=70, y=3, color=(200, 200, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    # City name bottom left, description bottom right
    t = helpers.render_text("Grenoble", x=2, y=14, color=(128, 128, 255), font_name="SYSTEM")
    frame = comp(frame, t)
    ...
    t = helpers.render_text("14:32", x=95, y=25, color=(100, 100, 100), font_name="SYSTEM")
    frame = comp(frame, t)
    return frame
...
def page1_b():
    ...
    t = helpers.render_text("C", x=28 + nw + 5, y=2, color=(255, 128, 0), font_name="MENU")
    frame = comp(frame, t)
    # Condition description
    t = helpers.render_text("Degage", x=28, y=15, color=(200, 200, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    # City right side
    t = helpers.render_text("Grenoble", x=80, y=15, color=(128, 128, 255), font_name="SYSTEM")
    frame = comp(frame, t)
    # Thin line
    pixels = frame.load()
...
def page1_c():
    ...
    t = helpers.render_text("C", x=22 + nw + 5, y=0, color=(255, 128, 0), font_name="MENU")
    frame = comp(frame, t)
    # Condition
    t = helpers.render_text("Degage", x=22, y=13, color=(200, 200, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    # City bottom spanning full width
    t = helpers.render_text("Grenoble", x=22, y=24, color=(128, 128, 255), font_name="SYSTEM")
    frame = comp(frame, t)
    # Right side: wind or extra info
    t = helpers.render_text("5 km/h", x=85, y=4, color=(100, 180, 100), font_name="SYSTEM")
    frame = comp(frame, t)
    t = helpers.render_text("65%", x=95, y=13, color=(100, 150, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    return frame
...
def page2_a():
    ...
    # Low temp
    t = helpers.render_text("18C", x=22, y=26, color=(100, 150, 255), font_name="SYSTEM")
    frame = comp(frame, t)
    # Condition on right
    t = helpers.render_text("Degage", x=70, y=4, color=(200, 200, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    return frame
...
def page2_b():
    ...
    t = helpers.render_text("DEMAIN", x=(128 - lw) // 2, y=0, color=(255, 200, 0), font_name="MENU")
    frame = comp(frame, t)
    # Icon centered
...
def page2_c():
    ...
    t = helpers.render_text("C", x=21 + nw + 5, y=13, color=(255, 100, 50), font_name="MENU")
    frame = comp(frame, t)
    t = helpers.render_text("18C", x=21, y=25, color=(100, 150, 255), font_name="SYSTEM")
    frame = comp(frame, t)
    # Right column: condition + extra
    t = helpers.render_text("Degage", x=70, y=14, color=(200, 200, 200), font_name="SYSTEM")
    frame = comp(frame, t)
    t = helpers.render_text("Vent: 12km/h", x=70, y=24, color=(100, 180, 100), font_name="SYSTEM")
    frame = comp(frame, t)
    return frame
...
def page3_a():
    ...
    for i in range(3):
        ...
        t = helpers.render_text(days[i], x=col_x + (col_w - nw) // 2, y=17, color=(200, 200, 200), font_name="SYSTEM")
        frame = comp(frame, t)
        # Temp
        tw = helpers.get_text_width(temps[i] + "C", "SYSTEM")
        t = helpers.render_text(temps[i] + "C", x=col_x + (col_w - tw) // 2, y=25, color=(255, 128, 0), font_name="SYSTEM")
        frame = comp(frame, t)
    # Vertical separators
    pixels = frame.load()
    for y in range(0, 32):
...
def page3_b():
    ...
    for i in range(3):
        ...
        # Day name top
        nw = helpers.get_text_width(days[i], "SYSTEM")
        t = helpers.render_text(days[i], x=col_x + (col_w - nw) // 2, y=0, color=(255, 200, 0), font_name="SYSTEM")
        frame = comp(frame, t)
        # Icon middle
        ix = col_x + (col_w - 16) // 2
...
def page3_c():
    ...
    for i in range(3):
        ...
        t = helpers.render_text(days[i].upper(), x=col_x + (col_w - nw) // 2, y=0, color=(255, 200, 0), font_name="MENU")
        frame = comp(frame, t)
        # Icon below
        ix = col_x + (col_w - 16) // 2
