...
const translations = {
    en: {
        ...
        "settings.brightness_section": "Brightness",
        "settings.brightness_level": "Brightness (0-15)",
        "settings.brightness_level_desc": "Hardware brightness level for the display.",
        "settings.night_mode": "Night Mode",
        "settings.night_mode_none": "Disabled",
        "settings.night_mode_schedule": "Fixed hours",
        "settings.night_mode_sun": "Sunrise/Sunset (auto)",
        "settings.schedule_night": "Hours and brightness (e.g. 22:00-08:00 20%)",
        "settings.schedule_night_desc": "Reduce brightness during these hours. Format: HH:MM-HH:MM percentage.",
        "settings.sunrise_brightness": "Daytime brightness %",
        "settings.sunrise_brightness_desc": "Brightness after sunrise (requires location).",
        "settings.sunset_brightness": "Nighttime brightness %",
        "settings.sunset_brightness_desc": "Brightness after sunset (requires location).",
        "settings.sun_needs_location": "⚠️ Sunrise/sunset mode requires a location. Configure it in the Location section.",
        ...
        "settings.debug_service": "Service",
        "settings.restart_service": "🔄 Restart zeClock",
        "settings.restart_hint": "Restarts the zeClock service. The page will reconnect automatically.",
    },
    ...
    fr: {
        ...
        "settings.brightness_section": "Luminosité",
        "settings.brightness_level": "Luminosité (0-15)",
        "settings.brightness_level_desc": "Niveau de luminosité matériel de l'afficheur.",
        "settings.night_mode": "Mode nuit",
        "settings.night_mode_none": "Désactivé",
        "settings.night_mode_schedule": "Heures fixes",
        "settings.night_mode_sun": "Lever/Coucher du soleil (auto)",
        "settings.schedule_night": "Heures et luminosité (ex. 22:00-08:00 20%)",
        "settings.schedule_night_desc": "Réduire la luminosité pendant ces heures. Format : HH:MM-HH:MM pourcentage.",
        "settings.sunrise_brightness": "Luminosité jour %",
        "settings.sunrise_brightness_desc": "Luminosité après le lever du soleil (nécessite la localisation).",
        "settings.sunset_brightness": "Luminosité nuit %",
        "settings.sunset_brightness_desc": "Luminosité après le coucher du soleil (nécessite la localisation).",
        "settings.sun_needs_location": "⚠️ Le mode lever/coucher du soleil nécessite une localisation. Configurez-la dans la section Localisation.",
        ...
        "settings.debug_service": "Service",
        "settings.restart_service": "🔄 Redémarrer zeClock",
        "settings.restart_hint": "Redémarre le service zeClock. La page se reconnectera automatiquement.",
    },
    ...
    de: {
        ...
        "settings.brightness_section": "Helligkeit",
        "settings.brightness_level": "Helligkeit (0-15)",
        "settings.brightness_level_desc": "Hardware-Helligkeitsstufe des Displays.",
        "settings.night_mode": "Nachtmodus",
        "settings.night_mode_none": "Deaktiviert",
        "settings.night_mode_schedule": "Feste Zeiten",
        "settings.night_mode_sun": "Sonnenauf-/untergang (auto)",
        "settings.schedule_night": "Zeiten und Helligkeit (z.B. 22:00-08:00 20%)",
        "settings.schedule_night_desc": "Helligkeit in diesen Stunden reduzieren. Format: HH:MM-HH:MM Prozent.",
        "settings.sunrise_brightness": "Tageshelligkeit %",
        "settings.sunrise_brightness_desc": "Helligkeit nach Sonnenaufgang (Standort erforderlich).",
        "settings.sunset_brightness": "Nachthelligkeit %",
        "settings.sunset_brightness_desc": "Helligkeit nach Sonnenuntergang (Standort erforderlich).",
        "settings.sun_needs_location": "⚠️ Der Sonnenauf-/untergangsmodus erfordert einen Standort. Konfigurieren Sie ihn im Bereich Standort.",
        "settings.rest_api": "REST-API",
        ...
        "settings.debug_service": "Service",
        "settings.restart_service": "🔄 zeClock neustarten",
        "settings.restart_hint": "Startet den zeClock-Dienst neu. Die Seite verbindet sich automatisch wieder.",
    },
    ...
    es: {
        ...
        "settings.brightness_section": "Brillo",
        "settings.brightness_level": "Brillo (0-15)",
        "settings.brightness_level_desc": "Nivel de brillo del hardware de la pantalla.",
        "settings.night_mode": "Modo nocturno",
        "settings.night_mode_none": "Desactivado",
        "settings.night_mode_schedule": "Horas fijas",
        "settings.night_mode_sun": "Amanecer/Atardecer (auto)",
        "settings.schedule_night": "Horas y brillo (ej. 22:00-08:00 20%)",
        "settings.schedule_night_desc": "Reducir brillo durante estas horas. Formato: HH:MM-HH:MM porcentaje.",
        "settings.sunrise_brightness": "Brillo diurno %",
        "settings.sunrise_brightness_desc": "Brillo después del amanecer (requiere ubicación).",
        "settings.sunset_brightness": "Brillo nocturno %",
        "settings.sunset_brightness_desc": "Brillo después del atardecer (requiere ubicación).",
        "settings.sun_needs_location": "⚠️ El modo amanecer/atardecer requiere una ubicación. Configúrela en la sección Ubicación.",
        "settings.rest_api": "API REST",
        ...
        "settings.debug_service": "Servicio",
        "settings.restart_service": "🔄 Reiniciar zeClock",
        "settings.restart_hint": "Reinicia el servicio zeClock. La página se reconectará automáticamente.",
    },
};
