    ...
    async def initialize(self, config: dict) -> None:
        ...
        if isinstance(location_raw, dict):
            ...
            if (
                ...
                # Use first part of display_name as city label
                self._city_name = (
                    full_name.split(",")[0].strip() if full_name else
                ...
                # Location object without coords — geocode the name
            ...
            # Location field is a plain string — geocode it
